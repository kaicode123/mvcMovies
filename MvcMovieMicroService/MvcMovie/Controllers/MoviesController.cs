...
namespace MvcMovie.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            {
                using (var response = await httpClient.GetAsync("http://apiget:7771/api/Movies"))
                {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            */
            ...
            using (var httpClient = new HttpClient())
            {
                using (var response = await httpClient.GetAsync("http://apidetail:7772/api/Movies/" + id))
                {
                    string apiResponse = await response.Content.ReadAsStringAsync();
                  //  moviesList = JsonConvert.DeserializeObject<List<Movie>>(apiResponse);
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,ReleaseDate,Genre,Price")] Movie movie)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                ...
                using (var response = await httpClient.PostAsync("http://apicreate:7773/api/Movies/", content))
                {
                    string apiResponse = await response.Content.ReadAsStringAsync();
                    movienew = JsonConvert.DeserializeObject<Movie>(apiResponse);
                }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                using (var response = await httpClient.GetAsync("http://apiedit:7774/api/Movies/" + id))
                {
                    string apiResponse = await response.Content.ReadAsStringAsync();
                    movienew = JsonConvert.DeserializeObject<Movie>(apiResponse);
                }
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,ReleaseDate,Genre,Price")] Movie movie)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                ...
                using (var response = await httpClient.PutAsync("http://apiedit:7774/api/Movies/" +id ,content))
                {
                    string apiResponse = await response.Content.ReadAsStringAsync();
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            */
            using (var httpClient = new HttpClient())
            {
                using (var response = await httpClient.DeleteAsync("http://apidelete:7775/api/Movies/" + id))
                {
                    string apiResponse = await response.Content.ReadAsStringAsync();
                }
            }
